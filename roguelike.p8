...
function _init()
	...
	itm_name=split("broad sword,leather armor,red bean paste,ninja star,rusty sword")
	itm_type=split("wep,arm,fud,thr,wep")
	itm_stat1=split("2,0,1,1,1")
	itm_stat2=split("0,2,0,0,0")
	
	mob_name=split("player,slime")
	mob_ani=split("240,192")
	mob_atk=split("1,1")
	mob_hp=split("5,1")
	mob_los=split("4,4")
...
function deco_farn(r,tx,ty,x,y)
	if mget(tx,ty)==1 then
		local tarr=split("1,70,70,70,71,71,71,72,73,74")
		mset(tx,ty,getrnd(tarr))
	end
end
